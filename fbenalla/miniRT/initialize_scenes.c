...
void	initialize_colors(t_color_fb *colors)
{
	colors->r = 0;
	colors->g = 0;
	colors->b = 0;
...
{
	scene->ambient_light = \
		malloc(sizeof(*(scene->ambient_light)));
	scene->ambient_light->color_ambient_light = \
		malloc(sizeof(*(scene->ambient_light->color_ambient_light)));
	scene->ambient_light->bright_ambient_light_fb = 0.0;
...
void	initialize_camera(t_scene *scene)
{
	...
	scene->camera->vector_camera = \
		malloc(sizeof(*(scene->camera->vector_camera)));
...
void	initialize_spher(t_scene *scene)
{
	...
	scene->sphere->color_sphere = \
		malloc(sizeof(*(scene->sphere->color_sphere)));
...
void	initialize_cylinder(t_scene *scene)
{
	...
	scene->cylinder->color_cylinder = \
		malloc(sizeof(*(scene->cylinder->color_cylinder)));
	scene->cylinder->coor_cylinder = \
		malloc(sizeof(*(scene->cylinder->coor_cylinder)));
	scene->cylinder->vector_cylinder = \
		malloc(sizeof(*(scene->cylinder->vector_cylinder)));
	scene->cylinder->height_cylinder_fb = 0;
