...
void	ft_camera(char **data, t_scene *scene)
{
	...
	scene->camera->coor_camera.x = ft_atoi(coors[0]);
	scene->camera->coor_camera.y = ft_atoi(coors[1]);
	scene->camera->coor_camera.z = ft_atoi(coors[2]);
...
{
	char **coors = ft_split(data[1], ',');
	scene->light->coor_light.x = ft_atoi(coors[0]);
	scene->light->coor_light.y = ft_atoi(coors[1]);
	scene->light->coor_light.z = ft_atoi(coors[2]);

	scene->light->bright_light = ft_atoi_double(data[2]);

	char **colors = ft_split(data[3], ',');
	scene->light->color_light.r = ft_atoi(coors[0]);
	scene->light->color_light.g = ft_atoi(coors[1]);
	scene->light->color_light.b = ft_atoi(coors[2]);
}
void	ft_plane(char **data, t_scene *scene)
{
	char **coors = ft_split(data[1], ',');
	scene->plane->coor_plane.x = ft_atoi(coors[0]);
	scene->plane->coor_plane.y = ft_atoi(coors[1]);
	scene->plane->coor_plane.z = ft_atoi(coors[2]);

	char **vects = ft_split(data[2], ',');
	scene->plane->color_plane.r = ft_atoi_double(vects[0]);
	scene->plane->color_plane.g = ft_atoi_double(vects[1]);
	scene->plane->color_plane.b = ft_atoi_double(vects[2]);

	char **colors = ft_split(data[3], ',');
	scene->plane->color_plane.r = ft_atoi(coors[0]);
	scene->plane->color_plane.g = ft_atoi(coors[1]);
	scene->plane->color_plane.b = ft_atoi(coors[2]);

}
void	ft_sphere(char **data, t_scene *scene)
{
	char **coors = ft_split(data[1], ',');
	scene->sphere->coor_sphere.x = ft_atoi(coors[0]);
	scene->sphere->coor_sphere.y = ft_atoi(coors[1]);
	scene->sphere->coor_sphere.z = ft_atoi(coors[2]);

	scene->sphere->diameter_sphere = ft_atoi_double(data[2]);

	char **colors = ft_split(data[3], ',');
	scene->sphere->color_sphere.r = ft_atoi(coors[0]);
	scene->sphere->color_sphere.g = ft_atoi(coors[1]);
	scene->sphere->color_sphere.b = ft_atoi(coors[2]);
}
void	ft_cylinder(char **data, t_scene *scene)
{
	char **coors = ft_split(data[1], ',');
	scene->cylinder->coor_cylinder.x = ft_atoi(coors[0]);
	scene->cylinder->coor_cylinder.y = ft_atoi(coors[1]);
	scene->cylinder->coor_cylinder.z = ft_atoi(coors[2]);

	char **vects = ft_split(data[2], ',');
	scene->cylinder->coor_cylinder.x = ft_atoi_double(vects[0]);
	scene->cylinder->coor_cylinder.y = ft_atoi_double(vects[1]);
	scene->cylinder->coor_cylinder.z = ft_atoi_double(vects[2]);
	...
	scene->cylinder->color_cylinder.r = ft_atoi(coors[0]);
	scene->cylinder->color_cylinder.g = ft_atoi(coors[1]);
	scene->cylinder->color_cylinder.b = ft_atoi(coors[2]);
}
