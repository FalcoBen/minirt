...
void	ft_light(char **data, t_scene *scene)
{
	...
	printf("-----------%d\n", new_light->color_light->r);
	printf("-----------%d\n", new_light->color_light->g);
	printf("-----------%d\n", new_light->color_light->b);
...
void	ft_plane(char **data, t_scene *scene)
{
	...
	{
		free(new_plane);
		exit_error("invalid arguments", "in pl", scene->cleaner);
	}
...
void	ft_sphere(char **data, t_scene *scene)
{
	...
	{
		free(new_sphere);
		exit_error("invalid arguments", "in sp", scene->cleaner);
	}
